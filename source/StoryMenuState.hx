...
class StoryMenuState extends MusicBeatState
{
	...
	var weekData:Array<Dynamic> = [["Tutorial"], ["Bopeebo", "Fresh", "Dadbattle"], ["Spookeez", "South", "Monster"], ["Pico", "Philly", "Blammed"], ["Satin-Panties", "High", "Milf"], ["Cocoa", "Eggnog", "Winter-Horrorland"], ["Senpai", "Roses", "Thorns"], ["Ugh", "Guns", "Stress"],["Darnell", "Lit-Up", "2Hot"]];
	var curDifficulty:Int = 0;

	public static var weekUnlocked:Array<Bool> = [true, true, true, true, true, true, true, true, true];

	var weekCharacters:Array<Dynamic> = [["dad", "bf", "gf"], ["dad", "bf", "gf"], ["spooky", "bf", "gf"], ["pico", "bf", "gf"], ["mom", "bf", "gf"], ["parents-christmas", "bf", "gf"], ["senpai", "bf", "gf"], ["tankman", "bf", "gf"], ["dad", "pico", "gf"]];
	...
	override function update(elapsed:Float)
	{
		...
		scoreText.text = "GLOBAL OFFLINE WEEK SCORE:" + Math.round(lerpScore);
...
class StoryMenuState2 extends MusicBeatState
{
	var scoreText:FlxText;
