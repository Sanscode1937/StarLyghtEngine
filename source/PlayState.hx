		...
		if (!PreferencesMenu.getPref('no-cutscene'))
			...
			tightBars.animation.callback = function(idle, frameNumber:Int, frameIndex:Int)
				...
				{						
					...
					{
						dad.alpha = 1;
						gfCutsceneLayer.remove(tightBars);
					});
